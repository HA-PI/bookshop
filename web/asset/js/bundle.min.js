...
$(global.document).ready(function () {
    $('#logout-btn').on('click', function (e) {
        ...
        confirm("确定退出吗？", function () {
            ...
            $.get("/api/user/logout", {}, function (_ref) {
                var code = _ref.code,
                    data = _ref.data;
...
},{"babel-polyfill":"babel-polyfill","bootstrap":"bootstrap","dialog":"dialog","jquery":"jquery"}],298:[function(require,module,exports){
/* ========================================================================
...
},{"core-js/fn/regexp/escape":1,"core-js/shim":294,"regenerator-runtime/runtime":296}],"bootstrap":[function(require,module,exports){
...
require('../../js/tab.js')
require('../../js/affix.js')
},{"../../js/affix.js":298,"../../js/alert.js":299,"../../js/button.js":300,"../../js/carousel.js":301,"../../js/collapse.js":302,"../../js/dropdown.js":303,"../../js/modal.js":304,"../../js/popover.js":305,"../../js/scrollspy.js":306,"../../js/tab.js":307,"../../js/tooltip.js":308,"../../js/transition.js":309}],"dialog":[function(require,module,exports){
/**
 * Created by Yc on 2016/3/1.
 */
+function () {
    jQuery.moyuAlert = function (content, onok, oncancel, title) {
        var default_val = {
        ...
        if(alert.length==0) {
            var modal = '<div id="moyuAlert" class="modal fade in" tabindex="-1" role="dialog">' +
                ...
                '<button type="button" role="moyu-cancel"' +
                ...
                '<button data-dismiss="modal" aria-label="Close" role="moyu-ok" type="button" class="btn btn-primary btn-sm">' +
                '确认</button>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>';
            $('body').append(modal);
            alert = $('#moyuAlert').modal({backdrop: 'static'});
        }else {
        ...
        alert.find('[role=moyu-cancel]').click(function(){
            $(this).off('click');
            if(oncancel)
                oncancel();
        });
        alert.find('[role=moyu-ok]').click(function(){
            $(this).off('click');
            if(onok)
                onok();
        });
    ...
    jQuery.moyuConfirm = function (content,onok,oncancel,title) {
        ...
        if(confirm.length==0) {
            var modal = '<div id="moyuConfirm" class="modal fade in" tabindex="-1" role="dialog">' +
                ...
                '</div>';
            $('body').append(modal);
            confirm = $('#moyuConfirm').modal({backdrop:'static'})
        }else{
            confirm.find('.modal-title').html((title ? title : default_val.title))
            confirm.find('p').html((content ? content : default_val.content));
            confirm.modal({backdrop: 'static'});
        }
        confirm.find('[role=moyu-cancel]').click(function(){
            $(this).off('click');
            if(oncancel)
                oncancel();
        });
        confirm.find('[role=moyu-ok]').click(function(){
            $(this).off('click');
            if(onok)
                onok();
        });
    ...
    if (module != null && module.exports) {
        console.log('loaded moyu-dialog')
        module.exports = {
            alert: jQuery.moyuAlert,
            confirm: jQuery.moyuConfirm
        }
    }
}();
...
},{"_process":295}],"jquery":[function(require,module,exports){
/*!
